module.exports = {
	...
	/* // Tim's heroku server
        ...
        'callbackURL': 'https://dry-harbor-12685.herokuapp.com/login/authorized'
        //'callbackURL'   : 'http://127.0.0.1:5500/login/authorized'
	*/

	// Zach's heroku server
        'clientID': '738740318135-56ced1ko1ttkdt58l6gg23udhhlmejus.apps.googleusercontent.com',
        'clientSecret'  : 'nSFS0akBCTvN6E0-w2g1G9Sa',
        'callbackURL'   : 'https://obscure-cliffs-65103.herokuapp.com/login/authorized'
        //'callbackURL'   : 'http://localhost:5500/login/authorized'
    }
